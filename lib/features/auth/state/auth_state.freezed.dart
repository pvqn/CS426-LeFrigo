...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String token, IsInfoComplete complete) loggedIn,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String token, IsInfoComplete complete)? loggedIn,
...
abstract class _$$_LoggedInCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, IsInfoComplete complete});
}
...
class _$_LoggedIn implements _LoggedIn {
  const _$_LoggedIn({required this.token, required this.complete});

  @override
  final String token;
  @override
  final IsInfoComplete complete;

  @override
  String toString() {
    return 'AuthState.loggedIn(token: $token, complete: $complete)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, token, complete);
  ...
  TResult when<TResult extends Object?>({
    ...
    return loggedIn(token, complete);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loggedIn?.call(token, complete);
  }
...
abstract class _LoggedIn implements AuthState {
  const factory _LoggedIn(
      ...
      required final IsInfoComplete complete}) = _$_LoggedIn;

  String get token;
  IsInfoComplete get complete;
  @JsonKey(ignore: true)
  _$$_LoggedInCopyWith<_$_LoggedIn> get copyWith =>
      throw _privateConstructorUsedError;
}
